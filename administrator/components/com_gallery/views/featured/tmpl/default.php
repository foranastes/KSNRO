...
<style>
    .icon-generic{
        ...
        height: 24px;
        margin-top: 7px;
        background-image: url(<?php echo JUri::root() ?>media/com_gallery/images/gallery-icon.png)!important;
    }
    .icon-radio-checked:before,
.icon-generic:before {
         content: none;           
         background: url(<?php echo JUri::root() ?>media/com_gallery/images/gallery-icon.png)!important;
}
...
<div id="j-sidebar-container" class="j-sidebar-container j-sidebar-visible" style="margin-top:1px;border-top: 1px solid #e3e3e3;padding-top:10px">
...
<div id="j-main-container" class="span10 j-toggle-main">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_gallery'); ?>" id="application-form" method="post" name="adminForm" class="form-validate" style="margin-top:10px">
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_gallery/images/lightbox.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_gallery/images/lightbox.png'; ?>"></a>
                </div>
            </div>
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_gallery/images/slider.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_gallery/images/slider.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
                <div class="title-block"><h3>Slider</h3></div>
                <div class="description-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_gallery/images/portfolio.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_gallery/images/portfolio.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_gallery/images/videogallery.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_gallery/images/videogallery.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
                <div class="title-block"><h3>Video Gallery</h3></div>
                <div class="description-block">
                    <p>Video Gallery plugin was created and specifically designed to show your video files in unusual splendid ways. It has 5 good-looking views. Each are made in different taste so that you can choose any of them, according to the style of your website. </div>			  				
                <div class="button-block">
                    <a href="http://huge-it.com/joomla-video-gallery/" target="_blank">View Extension</a>
                </div>
            </div>
        </div>
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_gallery/images/slideshow.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_gallery/images/slideshow.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_gallery/images/map.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_gallery/images/map.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_gallery/images/catalog.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_gallery/images/catalog.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
