  ...
  <div class="span10" style="width: 100%">
      <div class="back">
        <fieldset class="form-horizontal">
            <legend class="legend" ><?php echo JText::_('Container Style'); ?></legend>
            <?php foreach ($this->form->getFieldset('ThumbnailsContainerStyle') as $field): ?>
...
<?php endforeach; ?>
        ...
        <fieldset class="form-horizontal">
            ...
            <?php foreach ($this->form->getFieldset('ThumbnailsTitle') as $field): ?>
                <div class="control-group  options-block-title-wrapper first">
                    <?php
                    echo "<div class='control-label'>" . $field->label. "</div>";
                    echo "<div class='controls'>" . $field->input . "</div>";
...
<?php endforeach; ?>
        ...
        <fieldset class="form-horizontal">
            ...
            <?php foreach ($this->form->getFieldset('ThumbnailsImage') as $field): ?>
                <div class="control-group  options-block-title-wrapper first">
                    <?php
                    echo "<div class='control-label'>" . $field->label. "</div>";
                    echo "<div class='controls'>" . $field->input . "</div>";
