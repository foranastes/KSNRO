...
<div class="span10" style="width: 100%">
    <div class="back">
        <fieldset class="form-horizontal">
            ...
            <?php foreach ($this->form->getFieldset('Slider') as $field): ?>
...
<?php endforeach; ?>
       ...
       <div class="back">
        <fieldset class="form-horizontal">
            ...
            <?php foreach ($this->form->getFieldset('SliderDescription') as $field): ?>
                <div class="control-group  options-block-title-wrapper first">
                    <?php
                    echo "<div class='control-label'>" . $field->label. "</div>";
                    echo "<div class='controls'>" . $field->input . "</div>";
...
<?php endforeach; ?>
       ...
       <div class="back">
        <fieldset class="form-horizontal">
            ...
            <?php foreach ($this->form->getFieldset('SliderTitle') as $field): ?>
                <div class="control-group  options-block-title-wrapper first">
                    <?php
                    echo "<div class='control-label'>" . $field->label. "</div>";
                    echo "<div class='controls'>" . $field->input . "</div>";
...
<?php endforeach; ?>
          ...
          <div class="back">
        <fieldset class="form-horizontal">
            <legend class="legend" ><?php echo JText::_('Navigation'); ?></legend>
            <?php foreach ($this->form->getFieldset('SliderNavigation') as $field): ?>
            <div class="control-group  options-block-title-wrapper first">
                    <?php
                    echo "<div class='control-label'>" . $field->label. "</div>";
                    echo "<div class='controls'>" . $field->input . "</div>";
