...
class JFormFieldJSColor extends JFormField {
    ...
    public function getInput() {
        ...
        $doc->addScript(JURI::root(true) . "/media/com_gallery/js/simple-slider.js");
        $doc->addScript(JURI::root(true) . "/media/com_gallery/js/admin.js");
        ...
        $query1->select('*');
        $query1->from('#__huge_itgallery_params');
        $db->setQuery($query1);
        ...
        elseif ($type_ == "opacity" ) {
         ...
         elseif ($type_== "TransitionList") {
            return '<select  name="' . $this->name . '" id="' . $this->id . '"><option value="elastic" '.($results[0]['value'] =="elastic" ? "selected" : "" ).'>Elastic</option>
        ...
        elseif($type_ == "navigationTypeArrow"){
            $path = JURI::root().'media/com_gallery/images/Front_images/';
      ...
      elseif ($type_ == "number"){ 
            return '<input   type="number"  id ="' . $this->id . '" name="' . $this->name . '" value="' . $results[0]['value'] . '" '.$class.'   '.$labelclass.' />';
        }
       ...
       elseif ($type_ == "radio") {
        ...
        } elseif ($type_ == "light_box_overlayclose" || $type_ == 'light_box_loop' || $type_ == 'light_box_slideshowauto' || $type_ == 'light_box_fixed') {
