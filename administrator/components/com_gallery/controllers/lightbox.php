...
class GalleryControllerLightbox extends JControllerForm
{
     ...
     function  cancel($key = NULL){
        ...
        function apply1(){
             ...
             $this->setRedirect(JRoute::_('index.php?option=com_gallery&view=lightbox', false), JText::_('COM_GALLERY_SETTINGS'));
        }
}
