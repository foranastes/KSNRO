...
<div class="newslist catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="catItemBody">
	  ...
	  <!-- Item Image -->
	  <div class="ItemImageBlock newsimageblock">
		  <span class="catItemImage newsitemimage">
...
<div class="catItemHeader">
		...
		<!-- Date created -->
		<span class="catItemDateCreated newsdatecreated">
