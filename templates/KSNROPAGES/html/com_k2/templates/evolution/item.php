...
$doc->addStyleSheet('templates/KSNROPAGES/css/vertical-timeline.css');

?>
<div class="itemHeader evolutionhd">
...
<script src="/templates/KSNROPAGES/scripts/evolution.js" type="text/javascript"></script>

<script>
    $('#evolutiontable').verticalTimeline();
</script>
<!-- End K2 Item Layout -->
