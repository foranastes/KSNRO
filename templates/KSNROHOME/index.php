...
<h3 class="slideh">Kudumbashree National Resource Organisation<br><span style="font-size:20px;">Sharing experiences from Kerala with partner states</span></h3>
<div class="slidegrade2"></div>
</li>
 <li class="nroslide"><img src="images/slide1a.jpg" />
<h3 class="slideh">Progressing In Partnerships</br><span style="font-size:20px;">Presence in  20 states and 1 union territory</span></h3>
<div class="slidegrade2"></div>
</li>
...
<li class="nroslide"><img src="images/slide3a.jpg" />
<h3 class="slideh">Promoting Sustainable Rural Enterprises</h3>
<div class="slidegrade2"></div>
</li>
<li class="nroslide"><img src="images/slider7.jpg" />
<h3 class="slideh">Creating a National level Pool of Foot-Soldiers</h3>
<div class="slidegrade2"></div>
</li>
    	...
    	<div class="owl-two owl-carousel">
        	...
        	<li class="impactcol">
  			...
  			<li class="impactcol">
                ...
                <span class="impacttext">Gram Panchayats/Village Councils</span>
            </li>
  			<li class="impactcol">
            	<i class="fa fa-users" aria-hidden="true"></i>
				<span class="counter">4667</span>
                <span class="impacttext">Resource Persons trained</span>
            </li>
        	<li class="impactcol">
            	<i class="fa fa-users" aria-hidden="true"></i>
				<span class="counter">112</span>
                <span class="impacttext">Kerala Mentors</span>
            </li>
  			<li class="impactcol">
            	<i class="fa fa-users" aria-hidden="true"></i>
				<span class="counter">299</span>
                <span class="impacttext">Partner State Mentors</span>
            </li>
  			<li class="impactcol">
            	<i class="fa fa-users" aria-hidden="true"></i>
				<span class="counter">42</span>
                <span class="impacttext">Master Trainers</span>
            </li>
  			<li class="impactcol">
            	<i class="fa fa-university" aria-hidden="true"></i>
				<span class="counter">49799</span>
                <span class="impacttext">Self Help Groups</span>
            </li>
  			<li class="impactcol">
            	<i class="fa fa-university" aria-hidden="true"></i>
				<span class="counter">44263</span>
                <span class="impacttext">Enterprises</span>
            </li>
  			<li class="impactcol">
            	<i class="fa fa-university" aria-hidden="true"></i>
				<span class="counter">732</span>
                <span class="impacttext">SHG representatives trained</span>
            </li>
  			<li class="impactcol">
            	<i class="fa fa-university" aria-hidden="true"></i>
				<span class="counter">15376</span>
                <span class="impacttext">Female Entrepreneurs</span>
            </li>
  			<li class="impactcol">
            	<i class="fa fa-th-large" aria-hidden="true"></i>
				<span class="counter">67</span>
                <span class="impacttext">Professionals</span>
            </li>
		</div>
        </ul>
    </div>
