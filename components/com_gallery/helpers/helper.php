...
class GalleriesHelper {
    ...
    private function add_scripts() {
        ...
        JHtml::stylesheet(Juri::root() . 'media/com_gallery/style/gallery-all.css');
        JHtml::stylesheet(Juri::root() . 'media/com_gallery/style/style2-os.css');
        JHtml::stylesheet(Juri::root() . 'media/com_gallery/style/lightbox.css'); 
        JHtml::stylesheet(Juri::root() . 'media/com_gallery/style/css/font-awesome.css');
        
         $this->doc ->addScript("http://ajax.googleapis.com/ajax/libs/jquery/1.8.1/jquery.min.js");
         $this->doc ->addScript("http://code.jquery.com/ui/1.10.4/jquery-ui.js");
    ...
    private function get_data() {        
        ...
        $query ->select('*');
        $query -> from('#__huge_itgallery_params');
        $db->setQuery($query);
        $this->gen_params = $db->loadObjectList();
    }
    ...
    private function get_dataParams() {
        ...
        $id = $this->gallery_id;
        $query = $db->getQuery(true);
        $query->select('*,#__huge_itgallery_images.name as imgname,#__huge_itgallery_gallerys.description as pousetimeDescription');
        $query->from('#__huge_itgallery_gallerys,#__huge_itgallery_images');
        $query->where('#__huge_itgallery_gallerys.id ='.$id)->where('#__huge_itgallery_gallerys.id = #__huge_itgallery_images.gallery_id');
        $query ->order('#__huge_itgallery_images.ordering desc');
        $db->setQuery($query);
        $this->port_params = $db->loadObjectList();
    }
...
elseif(strpos($videourl,'vimeo') !== false && strpos($videourl,'video') !== false) {
    ...
    public function render_html() {
      ...
      //  if ($this->type != 'plugin')
        ...
        $paramssld = array();
        foreach ($this->gen_params as $rowpar) {
            $key = $rowpar->name;
            $value = $rowpar->value;
            $paramssld[$key] = $value;
        }
        $images = $this->port_params;      
        $like_dislike = 'off';
        
foreach ($this->port_params as $i => $gallery) {

    $galleryID = $gallery->id;
    $gallerytitle = $gallery->name;
    $galleryheight = $gallery->sl_height;
    $gallerywidth = $gallery->sl_width;
    $galleryeffect = $gallery->gallery_list_effects_s;
    $slidepausetime = ($gallery->pousetimeDescription + $gallery->param);
    $gallerypauseonhover = $gallery->pause_on_hover;
    $galleryposition = $gallery->sl_position;
    $slidechangespeed = $gallery->param;
    $gallerychangeview = $gallery->huge_it_sl_effects;   
    $like_dislike=$gallery->rating;
...
$pID = '';
if($paramssld['light_box_href']  == 'on' || $paramssld['light_box_href']  == 'true')$paramssld['light_box_href'] = "true"; else $paramssld['light_box_href']="false";
if($paramssld['light_box_title']  == 'on' || $paramssld['light_box_title'] == 'true')$paramssld['light_box_title'] = "true"; else $paramssld['light_box_title']="false";
if($paramssld['light_box_rel']  == 'on' || $paramssld['light_box_rel'] == 'true')$paramssld['light_box_rel'] = "true"; else $paramssld['light_box_rel']="false";
if($paramssld['light_box_scrolling']  == 'on' || $paramssld['light_box_scrolling'] = 'true')$paramssld['light_box_scrolling'] = "true"; else $paramssld['light_box_scrolling']="false";
if($paramssld['light_box_open']  == 'on' || $paramssld['light_box_open'] == 'true')$paramssld['light_box_open'] = "true"; else $paramssld['light_box_open']="false";
if($paramssld['light_box_esckey']  == 'on' || $paramssld['light_box_esckey'] == 'true')$paramssld['light_box_esckey'] == "true"; else $paramssld['light_box_esckey']="false";
if($paramssld['light_box_arrowkey']  == 'on' || $paramssld['light_box_arrowkey'] == 'true')$paramssld['light_box_arrowkey'] = "true"; else $paramssld['light_box_arrowkey']="false";
if($paramssld['light_box_data']  == 'on' || $paramssld['light_box_data']== 'true')$paramssld['light_box_data'] = "true"; else $paramssld['light_box_data']="false";
if($paramssld['light_box_classname']  == 'on' || $paramssld['light_box_classname'] == 'true')$paramssld['light_box_classname'] = "true"; else $paramssld['light_box_classname']="false";
if($paramssld['light_box_closebutton']  == 'on' || $paramssld['light_box_closebutton']== 'true')$paramssld['light_box_closebutton'] = "true"; else $paramssld['light_box_closebutton']="false";
if($paramssld['light_box_iframe']  == 'on' ||  $paramssld['light_box_iframe'] == 'true')$paramssld['light_box_iframe'] = "true"; else $paramssld['light_box_iframe']="false";
if($paramssld['light_box_inline']  == 'on' || $paramssld['light_box_inline'] == 'true')$paramssld['light_box_inline'] = "true"; else $paramssld['light_box_inline']="false";


if($paramssld['light_box_html']  == 'on' || $paramssld['light_box_html'] == 'true')$paramssld['light_box_html'] = "true"; else $paramssld['light_box_html']="false";
if($paramssld['light_box_photo']  == 'on' || $paramssld['light_box_photo'] == 'true')$paramssld['light_box_photo'] = "true"; else $paramssld['light_box_photo']="false";
if($paramssld['light_box_innerwidth']  == 'on' || $paramssld['light_box_innerwidth']=='true')$paramssld['light_box_innerwidth'] = "true"; else $paramssld['light_box_innerwidth']="false";
if($paramssld['light_box_innerheight']  == 'on' || $paramssld['light_box_innerheight'] == 'true')$paramssld['light_box_innerheight'] = "true"; else $paramssld['light_box_innerheight']="false";
if($paramssld['light_box_slideshow']  == 'on' || $paramssld['light_box_slideshow'] == 'true')$paramssld['light_box_slideshow'] = "true"; else $paramssld['light_box_slideshow']="false";


if($paramssld['light_box_top']  == 'on'|| $paramssld['light_box_top'] == 'true')$paramssld['light_box_top'] = "true"; else $paramssld['light_box_top']="false";
if($paramssld['light_box_bottom']  == 'on' || $paramssld['light_box_bottom'] == 'true')$paramssld['light_box_bottom'] = "true"; else $paramssld['light_box_bottom']="false";
if($paramssld['light_box_left']  == 'on' || $paramssld['light_box_left'] == 'true')$paramssld['light_box_left'] = "true"; else $paramssld['light_box_left']="false";
if($paramssld['light_box_right']  == 'on' || $paramssld['light_box_right'] == 'true')$paramssld['light_box_right'] = "true"; else $paramssld['light_box_right']="false";
if($paramssld['light_box_reposition']  == 'on' || $paramssld['light_box_reposition'] == 'true')$paramssld['light_box_reposition'] = "true"; else $paramssld['light_box_reposition']="false";


if($paramssld['light_box_retinaurl']  == 'on' || $paramssld['light_box_retinaurl'] == 'true')$paramssld['light_box_retinaurl'] = "true"; else $paramssld['light_box_retinaurl']="false";
if($paramssld['light_box_size_fix']  == 'on' || $paramssld['light_box_size_fix'] == 'true')$paramssld['light_box_size_fix'] = "true"; else $paramssld['light_box_size_fix']="false";
if($paramssld['light_box_scalephotos']  == 'on' || $paramssld['light_box_scalephotos'] == 'true')$paramssld['light_box_scalephotos'] = "true"; else $paramssld['light_box_scalephotos']="false";
if($paramssld['light_box_overlayclose']  == 'on' ||  $paramssld['light_box_overlayclose'] == 'true')$paramssld['light_box_overlayclose'] = "true"; else $paramssld['light_box_overlayclose']="false";
if($paramssld['light_box_loop']  == 'on' || $paramssld['light_box_loop'] == 'true')$paramssld['light_box_loop'] = "true"; else $paramssld['light_box_loop']="false";

if($paramssld['light_box_slideshowauto']  == 'on' || $paramssld['light_box_slideshowauto'] == 'true')$paramssld['light_box_slideshowauto'] = "true"; else $paramssld['light_box_slideshowauto']="false";
if($paramssld['light_box_fixed']  == 'on' || $paramssld['light_box_fixed'] == 'true')$paramssld['light_box_fixed'] = "true"; else $paramssld['light_box_fixed']="false";
if($paramssld['light_box_trapfocus']  == 'on' || $paramssld['light_box_trapfocus'] == 'true')$paramssld['light_box_trapfocus'] = "true"; else $paramssld['light_box_trapfocus']="false";
if($paramssld['light_box_fastiframe']  == 'on' || $paramssld['light_box_fastiframe'] == 'true')$paramssld['light_box_fastiframe'] = "true"; else $paramssld['light_box_fastiframe']="false";
if($paramssld['light_box_returnfocus']  == 'on' || $paramssld['light_box_returnfocus'] == 'true')$paramssld['light_box_returnfocus'] = "true"; else $paramssld['light_box_returnfocus']="false";
if($paramssld['light_box_preloading']  == 'on' || $paramssld['light_box_preloading'] == 'true')$paramssld['light_box_preloading'] = "true"; else $paramssld['light_box_preloading']="false";
if($paramssld['light_box_retinaimage']  == 'on' || $paramssld['light_box_retinaimage'] == 'true')$paramssld['light_box_retinaimage'] = "true"; else $paramssld['light_box_retinaimage']="false";
if($paramssld['light_box_next']  == 'on' || $paramssld['light_box_next'] == 'true')$paramssld['light_box_retinaimage'] = "Next"; else $paramssld['light_box_next']="Next";
if($paramssld['light_box_previous']  == 'on' || $paramssld['light_box_previous'] == 'true')$paramssld['light_box_previous'] = "Previous"; else $paramssld['light_box_previous']="Previous";
/***<optimize_images>***/
...
<link  rel="stylesheet" type="text/css"  href="<?php echo JURI::root() . 'media/com_gallery/style/colorbox-'.$paramssld['light_box_style'].'.css';?>">
<script src="<?php echo JURI::root() . 'media/com_gallery/js/jquery.isotope.min.js' ?>"></script>
<script src="<?php echo JURI::root() . 'media/com_gallery/js/jquery.colorbox.js' ?>"></script>
<script src="<?php echo JURI::root() . 'media/com_gallery/js/gallery-all.js' ?>"></script>
<!--<script src="<?php // echo JURI::root() . 'media/com_gallery/js/gallery-all.js'  ?>"></script>-->


<link href="<?php echo JURI::root() . 'media/com_gallery/style/colorbox-' . $paramssld['light_box_style'] . '.css' ?>" rel="stylesheet" type="text/css" />	<?php
$i = $gallerychangeview;
switch ($i) {
    case 0: 
...
.element_<?php echo $galleryID; ?> .image-block_<?php echo $galleryID; ?> {
	<?php if($paramssld['image_natural_size_contentpopup']=='resize'){?>
	position:relative;
	width:100%;
	<?php }elseif($paramssld['image_natural_size_contentpopup']=='natural'){?>
		position:relative;
		width:100%;
		overflow: hidden;
...
.element_<?php echo $galleryID; ?> .image-block_<?php echo $galleryID; ?> .gallery-image-overlay a {
	...
	width:100%;
	height:100%;
        background:url('<?php echo JUri::root().'media/com_gallery/images/zoom.'.$paramssld["ht_view2_zoombutton_style"].'.png'; ?>') center center no-repeat;
}
		 /*   background: url('<?php echo JUri::root().'media/com_gallery/images/like.png'; ?>')*/
...
#huge_it_gallery_popup_list_<?php echo $galleryID; ?> .heading-navigation_<?php echo $galleryID; ?> {
	...
	left:0px;
	z-index:2001;
	background:url('<?php echo  JUri::root().'media/com_gallery/images/divider.line.png'; ?>') center bottom repeat-x;
}
#huge_it_gallery_popup_list_<?php echo $galleryID; ?> .heading-navigation_<?php echo $galleryID; ?> .close,#huge_it_gallery_popup_list_<?php echo $galleryID; ?> .heading-navigation_<?php echo $galleryID; ?> .close:link, #huge_it_gallery_popup_list_<?php echo $galleryID; ?> .heading-navigation_<?php echo $galleryID; ?> .close:visited {
	...
	height:40px;
	display:block;
	background:url('<?php echo  JUri::root().'media/com_gallery/images/close.popup.'.$paramssld["ht_view2_popup_closebutton_style"].'.png'; ?>') center center no-repeat;
...
#huge_it_gallery_popup_list_<?php echo $galleryID; ?> li.pupup-element .popup-wrapper_<?php echo $galleryID; ?> .right-block > div {
	...
	<?php if($paramssld['ht_view2_show_separator_lines']=="on") {?>
		background:url('<?php echo  JUri::root().'media/com_gallery/images/divider.line.png'; ?>') center top repeat-x;
	<?php } ?>
}
...
<section id="huge_it_gallery_content_<?php echo $galleryID; ?>" >
  <div id="huge_it_gallery_container_<?php echo $galleryID; ?>" class="super-list variable-sizes clearfix">
  	...
  	<?php
			...
			$idofgallery=intval($image->gallery_id);
			...
			$pattern='/-/';
                        ...
                        $query2->order('#__huge_itgallery_gallerys.ordering asc');
                        $db->setQuery($query2);
...
<style>
	...
	?>;
		...
		#huge_it_gallery_content_<?php echo $galleryID; ?> .huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .huge_it_dislike .huge_it_dislike_thumb {
			...
			position:relative;
			height: 28px;
                        /*background:url('<?php echo JUri::root().'media/com_gallery/images/dislike.png'; ?>') 2.5px center no-repeat;*/
		}
...
<?php
		...
		//print_r($count);
			...
			$start = $page * $num - $num; 
                        ...
                        $query->where('gallery_id ='.$idofgallery);
		...
		<div class="element_<?php echo $galleryID; ?>" tabindex="0" data-symbol="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" data-category="alkaline-earth">
			...
			<?php
				...
				?>									
                            ...
                            <img alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" id="wd-cl-img<?php echo $key; ?>" src="<?php echo $imgurl[0]; ?>"  />
							<?php } else { ?>
				...
				?>
							<?php
								$videourl=$this->get_video_id_from_url($row->image_url);
			...
			<div class="title-block_<?php echo $galleryID; ?>"><?php if($row->name != '' && $row->name != null){?>
					<h3><?php echo 	str_replace('__5_5_5__','%',$row->name); ?></h3><?php }?>
  ...
  <?php 
		 $path_site = JUri::root()."media/com_gallery/images/Front_images"; 
			$a=$disp_type;
			if($a==1){
 ...
 //}
				...
				<div class="load_more5">
					...
					<script>
						jQuery(document).ready(function(){
							if(jQuery("#huge_it_gallery_content_<?php echo $galleryID ; ?> .load_more_button5").length){
								jQuery("#huge_it_gallery_content_<?php echo $galleryID ?> .load_more5 .load_more_button5").on("click tap",function(){
									if(jQuery("#huge_it_gallery_content_<?php echo $galleryID; ?> .pagenum:last").val()<jQuery("#huge_it_gallery_container_<?php echo $galleryID; ?> #total").val()) {
										var pagenum = parseInt(jQuery("#huge_it_gallery_content_<?php echo $galleryID; ?> .pagenum:last").val()) + 1;
										var perpage =<?=$count_page; ?>;
										var galleryid="<?=$galleryID; ?>";
                                        var idGallery="<?php echo $idofgallery; ?>";
										...
										getresult(pagenum,perpage,galleryid,thumbtext,linkbutton,showbutton,pID,likeStyle,ratingCount,idGallery);
									}else{
										jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .load_more_button5').hide();
									}
									return false;
								});
							}
							...
							function getresult(pagenum,perpage,galleryid,thumbtext,linkbutton,showbutton,pID,likeStyle,ratingCount,idGallery){
								var data = {
								...
								jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .loading5').show();
								jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .load_more_button5').hide();
								jQuery.post('<?php echo $path_menu;?>components/com_gallery/ajax_url.php',data,function(response){
                                                                    if(response.success){
                                                                        var $objnewitems= jQuery(response.success);										
                                                                        jQuery('#huge_it_gallery_container_moving_<?php echo $galleryID; ?>').append( $objnewitems ).isotope( 'reloadItems' ).isotope({ sortBy: 'original-order' }).isotope( 'reLayout' );
                                                                        jQuery('#huge_it_gallery_container_moving_<?php echo $galleryID; ?> img').on('load',function(){
                                                                        jQuery("#huge_it_videogallery_container_<?php echo $galleryID; ?>").append(response.success);
                                                                        jQuery(function(){
                                                                            var defaultBlockHeight=<?php echo $paramssld['ht_view2_element_height']+37; ?>;
                                                                                var defaultBlockWidth=(<?php echo $paramssld['ht_view2_element_width']; ?>);
                                                                            var $container = jQuery('#huge_it_gallery_container_moving_<?php echo $galleryID; ?>');
											...
											jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .load_more_button5').show();
											jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .loading5').hide();
											if(jQuery("#huge_it_gallery_content_<?php echo $galleryID; ?> .pagenum:last").val()==jQuery("#huge_it_gallery_container_<?php echo $galleryID; ?> #total").val()) {
												jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .load_more_button5').hide();
											}
											<?php if($like_dislike != 'heart'){?>
		...
		?>
			...
			//var_dump($res);  
			// Провер�?ем нужны ли �?трелки назад  
				$pervpage='';
			...
			// Провер�?ем нужны ли �?трелки вперед  
		       $nextpage='';
	...
	foreach($images as $key=>$row)
	{
		...
		<li class="pupup-element" id="huge_it_gallery_pupup_element_<?php echo $row->id; ?>">
			...
			<div class="popup-wrapper_<?php echo $galleryID; ?>">
				...
				$viwMoreButton='<div class="button-block"><a href="'.str_replace('__5_5_5__','%',$row->sl_url).'" '.$target.' >'.$paramssld["ht_view2_popup_linkbutton_text"].'</a></div>';
			}
			?>
				</div>
				<div class="right-block"><?php if($paramssld["ht_view2_show_popup_title"]=='on' && $row->name != '' && $row->name != null){?><h3 class="title"><?php echo str_replace('__5_5_5__','%',$row->name); ?></h3><?php } ?>
					<?php if($paramssld["ht_view2_show_description"]=='on'){?><div class="description"><?php echo str_replace('__5_5_5__','%',$row->description); ?></div>
					<?php } ?>
...
jQuery(window).load(function(){
	jQuery(".element_<?php echo $galleryID; ?> .image-block_<?php echo $galleryID; ?> img").each(function(i, img) {
...
<link href="<?php echo JUri::root().'media/com_gallery/style/liquid-slider.css';?>" rel="stylesheet" type="text/css" />
...
[class$="-arrow"] {
    background-image:url(<?php echo JUri::root().'media/com_gallery/images/arrow.'.$paramssld["ht_view5_icons_style"].'.png';?>);
}
.ls-select-box {
	background:url(<?php echo JUri::root().'media/com_gallery/images/menu.'.$paramssld["ht_view5_icons_style"].'.png';?>) right center no-repeat #<?php echo $paramssld["ht_view5_slider_background_color"];?>;
}
...
#main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .image-block_<?php echo $galleryID; ?>  .play-icon.youtube-icon {background:url(<?php echo Juri::root( ); ?>media/com_gallery/images/play.youtube.png) center center no-repeat;}
#main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .image-block_<?php echo $galleryID; ?>  .play-icon.vimeo-icon {background:url(<?php echo Juri::root( ); ?>media/com_gallery/images/play.vimeo.png) center center no-repeat;}
...
#main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .button-block a,#main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .button-block a:link,#main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .button-block a:visited{
	...
	font-size:<?php echo $paramssld["ht_view5_linkbutton_font_size"];?>px;
	text-decoration:none;
}
		...
		<div class="slider-content">
			<div class="slider-content-wrapper">
				<div class="image-block_<?php echo $galleryID; ?>">
					...
					<?php 
						...
						switch($imagerowstype){
							case 'image':
					?>				
                                    <?php $imgurl[0] =  $row->image_url; ?>
							<?php 	if($row->image_url != ';'){ ?>
                                    <a class="gallery_group<?php echo $galleryID; ?>" href="<?php echo $imgurl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>"><img alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" class="main-image" src="<?php echo $imgurl[0]; ?>"  /></a>
							<?php } else { ?>
				...
				<div class="right-block">					<?php if($row->name != '' && $row->name != null) {?>
						<div><h2 class="title"><?php echo str_replace('__5_5_5__','%',$row->name); ?></h2></div>					<?php }?>
...
<script src="<?php echo JUri::root().'media/com_gallery/js/jquery.liquid-slider.min.js';?>"></script>  
   <script>
    /**
...
.element_<?php echo $galleryID; ?> .image-block_<?php echo $galleryID; ?>  .play-icon.youtube-icon {background:url(<?php echo JUri::root(); ?>media/com_gallery/images/play.youtube.png) center center no-repeat;}
.element_<?php echo $galleryID; ?> .image-block_<?php echo $galleryID; ?>  .play-icon.vimeo-icon {background:url(<?php echo JUri::root(); ?>media/com_gallery/images/play.vimeo.png) center center no-repeat;}
.element_<?php echo $galleryID; ?> .title-block_<?php echo $galleryID; ?> {
	position:absolute;
	left:0px;
	width:100%;
...
<section id="huge_it_gallery_content_<?php echo $galleryID; ?>">
  <div id="huge_it_gallery_container_<?php echo $galleryID; ?>" class="super-list variable-sizes clearfix">
	...
	foreach($page_images as $key=>$row)
	{
		...
		$result = substr($descnohtml, 0, 50);
		?>
		<div class="element_<?php echo $galleryID; ?>" tabindex="0" data-symbol="<?php echo 
str_replace('__5_5_5__','%',$row->name); ?>" data-category="alkaline-earth">
			<div class="image-block_<?php echo $galleryID; ?>">
				...
				?>									
							<?php $imgurl=explode(";",$row->image_url); ?>
							<?php 	if($row->image_url != ';'){ ?>
                            <a href="<?php echo $imgurl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>"><img alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" id="wd-cl-img<?php echo $key; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" src="<?php echo $imgurl[0]; ?>"  /></a>
							<?php } else { ?>
							<img alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" id="wd-cl-img<?php echo $key; ?>" src="images/noimage.jpg"  />
							<?php
							} ?>
                        ...
                        jQuery(document).ready(function(){
                            if(jQuery("#huge_it_gallery_content_<?php echo $galleryID; ?> .load_more_button4").length){
                                jQuery("#huge_it_gallery_content_<?php echo $galleryID; ?> .load_more_button4").on("click tap",function(){
                                    ...
                                    if(parseInt(jQuery("#huge_it_gallery_content_<?php echo $galleryID; ?> .pagenum:last").val())<parseInt(jQuery("#huge_it_gallery_container_<?php echo $galleryID; ?> #total").val())) {
                                        ...
                                        getresult(pagenum,perpage,galleryid,thumbtext,pID,likeStyle,ratingCount,idGallery);
                                    }else{
                            ...
                            if(parseInt(jQuery("#huge_it_gallery_content_<?php echo $galleryID; ?> .pagenum:last").val())==parseInt(jQuery("#huge_it_gallery_container_<?php echo $galleryID; ?> #total").val())) {
                                jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .load_more_button4').hide();
                            }
                            function getresult(pagenum,perpage,galleryid,thumbtext,pID,likeStyle,ratingCount,idGallery){
                                var data = {
                                    action:"huge_it_video_gallery_ajax",
                                ...
                                jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .loading4').show();
                                jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .load_more_button4').hide();
                                jQuery.post("<?php echo $path_menu;?>components/com_gallery/ajax_url.php",data,function(response){
                                    if(response.success){
                                        var $objnewitems= jQuery(response.success);
                                        jQuery('#huge_it_gallery_container_moving_<?php echo $galleryID; ?>').append( $objnewitems ).isotope( 'prepended' ).isotope({ sortBy: 'original-order' }) .isotope( 'reLayout' ).isotope( 'reloadItems' );
                                        jQuery('#huge_it_gallery_container_moving_<?php echo $galleryID; ?> img').on('load',function(){
                                            jQuery('#huge_it_gallery_container_moving_<?php echo $galleryID; ?>').isotope( 'prepended' ).isotope({ sortBy: 'original-order' }) .isotope( 'reLayout' ).isotope( 'reloadItems' );
                                            jQuery("#huge_it_gallery_content_<?php echo $galleryID; ?> a[href$='.jpg'], #huge_it_gallery_content_<?php echo $galleryID; ?> a[href$='.jpeg'], #huge_it_gallery_content_<?php echo $galleryID; ?> a[href$='.png'], #huge_it_gallery_content_<?php echo $galleryID; ?> a[href$='.gif']").addClass('gallery_group<?php echo $galleryID; ?>');
                                            jQuery(".gallery_group<?php echo $galleryID; ?>").colorbox({rel:'gallery_group<?php echo $galleryID; ?>'});
                                            jQuery(".youtube").colorbox({iframe:true, innerWidth:640, innerHeight:390});
                                            jQuery(".vimeo").colorbox({iframe:true, innerWidth:640, innerHeight:390});
                                            ...
                                            jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .load_more_button4').show();
                                            jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .loading4').hide();
                                            if(jQuery("#huge_it_gallery_content_<?php echo $galleryID; ?> .pagenum:last").val()==jQuery("#huge_it_gallery_container_<?php echo $galleryID; ?> #total").val()) {
                                                jQuery('#huge_it_gallery_content_<?php echo $galleryID; ?> .load_more_button4').hide();
                                            }
                                            <?php if($like_dislike != 'heart'){?>
...
<?php
    ...
    case 3:
	$sliderID=$gallery->id;
	$slidertitle=$gallery->name;
	$sliderheight=$gallery->sl_height;
	$sliderwidth=$gallery->sl_width;
	$slidereffect=$gallery->gallery_list_effects_s;
	$slidepausetime=($gallery->pousetimeDescription+$gallery->param);
	$sliderpauseonhover=$gallery->pause_on_hover;
	$sliderposition=$gallery->sl_position;
	$slidechangespeed=$gallery->param;
...
<script src="<?php echo JUri::root().'media/com_gallery/js/vimeo.lib.js'; ?>"></script>
<script>
jQuery(function(){
...
<script src="<?php echo JUri::root().'media/com_gallery/js/youtube.lib.js';?>"></script>
<script> 
  <?php
...
<script>
	...
	?>
     ...
     function huge_it_change_image_gallery_<?php echo $sliderID; ?>(current_key, key, data_gallery_<?php echo $sliderID; ?>, from_effect,clicked) {
		...
		if(jQuery('.huge_it_slideshow_description_text_gallery_<?php echo $sliderID; ?>').html()==""){
			jQuery('.huge_it_slideshow_description_text_gallery_<?php echo $sliderID; ?>').addClass('none');
		}
	...
	?>;
		...
		@media screen and (min-width: 768px){
			...
			.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .huge_it_gallery_like_wrapper:hover .likeheart {
                ...
                .youtube-icon {background:url(<?php echo JUri::root(); ?>media/com_gallery/images/play.youtube.png) center center no-repeat;}
		.vimeo-icon {background:url(<?php echo JUri::root(); ?>media/com_gallery/images/play.vimeo.png) center center no-repeat;}
		.playbutton{
			width: 100%;
			height: 100%;
			position: absolute;
		...
		$arrowfolder=  JUri::root().'media/com_gallery/images/Front_images/arrows';
			...
			case 2:
				?>
					...
					#huge_it_slideshow_right_gallery_<?php echo $sliderID; ?> {
						...
						height:50px;
						width:50px;
						background:url(<?php echo $arrowfolder;?>/arrows.circle.shadow.png) right top no-repeat !important; 
					}
...
?>
          ...
          <div class="huge_it_slide_bg_gallery_<?php echo $sliderID; ?>">
			...
			<?php
				...
				foreach ($images as $key => $image_row) {
					...
					$icon=$this->get_video_id_from_url($videourl);
			...
			?>
            </ul>			<input type="hidden" id="huge_it_current_image_key_gallery_<?php echo $sliderID; ?>" value="0" />
          </div>
        </div>
      </div>
	</div>
    ...
    <?php
        break;	
            ...
            case 4:
    ?>
        <link href="<?php echo JUri::root().'media/com_gallery/style/thumb_view.css';?>" rel="stylesheet" type="text/css" />
        <script src="<?php echo JUri::root().'media/com_gallery/js/thumb_view.min.js';?>"></script>
        <script src="<?php  echo JUri::root().'media/com_gallery/js/jquery.lazyload.min.js' ; ?>"></script>
        ...
        <style>
			...
			#huge_it_gallery .huge_it_big_li {
				<?php if($paramssld["image_natural_size_thumbnail"]=='resize'){?>
				overflow:hidden;
				width: 100%;	
				...
				padding:<?php echo $paramssld['thumb_box_padding']?>px !important;
				<?php }
				elseif($paramssld["image_natural_size_thumbnail"]=='natural'){
				?>
				overflow:hidden;
			...
			.clear{
  			...
  			section #huge_it_gallery li:hover .overLayer {
				...
				background: #<?php echo $paramssld["thumb_title_background_color"]; ?>; 
                                border-radius: <?php echo $paramssld["thumb_image_border_radius"]; ?>px;
                                margin:<?php echo $paramssld['thumb_box_padding']?>px !important;
			}
		 ...
		 $path_site = JUri::root()."media/com_gallery/images/Front_images"; 
			...
			if($a==1){
				...
				<div class="load_more3">
					...
					<script>
						jQuery(document).ready(function(){
							if(jQuery("#thumbwrapper<?=$galleryID; ?> .load_more_button3").length){
								jQuery("#thumbwrapper<?=$galleryID; ?> .load_more_button3").on("click tap",function(){
									if(parseInt(jQuery("#thumbwrapper<?=$galleryID; ?> .pagenum:last").val())<parseInt(jQuery("#thumbwrapper<?=$galleryID; ?> #total").val())) {
										var pagenum = parseInt(jQuery("#thumbwrapper<?=$galleryID; ?> .pagenum:last").val()) + 1;
										var perpage =<?=$count_page; ?>;
										var galleryid="<?=$galleryID; ?>";
                                        var idGallery="<?php echo $idofgallery; ?>";
										var thumbtext="<?php echo $paramssld["thumb_view_text"]; ?>";
										...
										jQuery('#thumbwrapper<?=$galleryID; ?> .load_more_button3').hide();
									}
									return false;
								});
							}
					...
					function getresult(pagenum,perpage,galleryid,thumbtext,pID,likeStyle,ratingCount,idGallery){
								...
								jQuery('#thumbwrapper<?=$galleryID; ?> .loading3').show();
								jQuery('#thumbwrapper<?=$galleryID; ?> .load_more_button3').hide();
								jQuery.post('<?php echo $path_menu;?>components/com_gallery/ajax_url.php',data,function(response){
									if(response.success){
										jQuery("#thumbwrapper<?=$galleryID; ?> #huge_it_gallery").append(response.success);
										jQuery('#thumbwrapper<?=$galleryID; ?> #huge_it_gallery img').on('load',function(){
											jQuery(".gallery_group<?php echo $galleryID; ?>").colorbox({rel:'gallery_group<?php echo $galleryID; ?>'});
											jQuery(".youtube").colorbox({iframe:true, innerWidth:640, innerHeight:390});
											jQuery(".vimeo").colorbox({iframe:true, innerWidth:640, innerHeight:390});
											jQuery(".iframe").colorbox({iframe:true, width:"80%", height:"80%"});
											...
											jQuery('.non-retina').colorbox({rel:'group5', transition:'none'})
											jQuery('.retina').colorbox({rel:'group5', transition:'none', retinaImage:true, retinaUrl:true});
											jQuery('#thumbwrapper<?=$galleryID; ?> .load_more_button3').show();
											jQuery('#thumbwrapper<?=$galleryID; ?> .loading3').hide();
											if(parseInt(jQuery("#thumbwrapper<?=$galleryID; ?> .pagenum:last").val())==parseInt(jQuery("#thumbwrapper<?=$galleryID; ?> #total").val())) {
												jQuery('#thumbwrapper<?=$galleryID; ?> .load_more_button3').hide();
											}
											<?php if($like_dislike != 'heart'){?>
...
<link rel="stylesheet" href="<?php echo $path_site ; ?>/media/com_gallery/style/justifiedGallery.css" />

<?php if($paramssld["ht_view8_element_randomize"] == 'off') $paramssld["ht_view8_element_randomize"] = 'false'; else $paramssld["ht_view8_element_randomize"] = 'true'; ?>
<?php if($paramssld["ht_view8_element_cssAnimation"] == 'off')  $paramssld["ht_view8_element_cssAnimation"] = 'false'; else  $paramssld["ht_view8_element_cssAnimation"] = 'true'; ?>
<?php if($paramssld["ht_view8_element_justify"] == 'off')  $paramssld["ht_view8_element_justify"] = 'false'; else  $paramssld["ht_view8_element_justify"] = 'true'; ?>
<?php if($paramssld["ht_view8_element_show_caption"] == 'off') $paramssld["ht_view8_element_show_caption"] = 'false'; else  $paramssld["ht_view8_element_show_caption"] = 'true'; ?>
...
<script src="<?php echo $path_site ; ?>/media/com_gallery/js/justifiedGallery.js"></script>
...
<style>
	...
	.clear{
        ...
        .play-icon.youtube-icon {background:url(<?php echo JUri::root(); ?>media/com_gallery/images/play.youtube.png) center center no-repeat;}
        .play-icon.vimeo-icon {background:url(<?php echo JUri::root(); ?>media/com_gallery/images/play.vimeo.png) center center no-repeat;}
<?php	switch ($like_dislike) {
    case "dislike":
        ?>
    /*/////Like/Dislike Styles BEGIN/////like/dislike///////*/
...
<div id="mygallery_wrapper_<?php echo $galleryID; ?>" class="clearfix">
				...
				<input type="hidden" id="total" value="<?=$total; ?>" />
                    ...
                    ?>
                                ...
                                <a class="gallery_group<?php echo $galleryID; ?>" href="<?php echo $imgurl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
                                    <img  id="wd-cl-img<?php echo $key; ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" src="<?php echo $imgurl[0]; ?>"/>
                                <?php if($like_dislike != 'off'):?>
									<div class="huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?>">
										<div class="huge_it_gallery_like_wrapper">
										<span class="huge_it_like">
						...
						jQuery(document).ready(function(){
							if(jQuery("#mygallery_wrapper_<?php echo $galleryID; ?> .load_more_button_<?php echo $galleryID; ?>").length){
								jQuery("#mygallery_wrapper_<?php echo $galleryID; ?> .load_more_button_<?php echo $galleryID; ?>").on("click tap",function(){
									if(parseInt(jQuery("#mygallery_<?php echo $galleryID; ?> .pagenum:last").val())<parseInt(jQuery("#mygallery_wrapper_<?php echo $galleryID; ?> #total").val())) {
										...
										getresult(pagenum,perpage,galleryid,pID,likeStyle,ratingCount,idGallery);
									}else{
							...
							if(parseInt(jQuery("#mygallery_<?php echo $galleryID; ?> .pagenum:last").val())==parseInt(jQuery("#mygallery_<?php echo $galleryID; ?> #total").val())) {
												jQuery('#mygallery_wrapper_<?php echo $galleryID; ?> .load_more_button_<?php echo $galleryID; ?>').hide();
											}			
							function getresult(pagenum,perpage,galleryid,pID,likeStyle,ratingCount,idGallery){
								var data = {
										action:"huge_it_video_gallery_ajax",
		...
		<div class="paginate2">
			...
			if ($page != $total) $nextpage = ' <a href= '.$checkREQ.'='. ($page + 1) .'><i class="hugeiticons hugeiticons-chevron-right"></i></a>  
			                                   <a href= '.$checkREQ.'=' .$total. '><i class="hugeiticons hugeiticons-fast-forward" ></i></a>';  
			// �?аходим две ближайшие �?таницы �? обоих краев, е�?ли они е�?ть  
